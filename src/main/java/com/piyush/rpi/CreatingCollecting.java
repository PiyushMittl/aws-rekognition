...
public class CreatingCollecting {
	...
	public static void main(String[] args) throws Exception {
		...
		String collectionId = "airtel";
		// String collectionId2 = "exampleCollection33";
		System.out.println("Creating collections: " + collectionId);
		...
		// .toString());
		//
		// DeleteCollectionResult deleteCollectionResult2 =
		// callDeleteCollection(
		// collectionId2, amazonRekognition);
		// System.out.println(collectionId2 + ": " +
		// deleteCollectionResult2.getStatusCode()
		// .toString());
